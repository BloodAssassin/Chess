...
namespace ServerForm
{
    class SqlAccess
    {
        ...
        static string host = "localhost";     //连接服务器的IP地址
        //static string host = "115.159.207.34";     //连接服务器的IP地址
        static string id = "admin";              //UserID
        static string pwd = "admin";           //密码
        static string database = "chess";        //数据库的名称
